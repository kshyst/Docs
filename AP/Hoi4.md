...
** اسارت** : درصد اسارت یک گردان مشخص میکند که بعد از حمله یا دفاع ، چند درصد از قدرت خود را به گردان حریف می‌بازد. در صورت باختن ، **قدرت آن گردان** * **درصد اسارت** به قدرت همه گردان های از همان نوع حریف اضافه می‌شود. قدرت ها ضرب شده مربوط به قدرت پایه و قبل از اعمال اثرات هوا و ترین است.
...
```
power = battalion_power * count * terrain_modifier * weather_modifier
```
